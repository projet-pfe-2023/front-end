...
@Component({
  ...
  styleUrls: ['./gestion-formulaire.component.css']
})
export class GestionFormulaireComponent implements AfterViewInit {
  displayedColumns: string[] = ['Code', 'Nom', 'Procedure','Details'];
...
const ELEMENT_DATA: PeriodicElement[] = [
  {Code: 'aaaa', Nom: 'Hydrogen', Procedure: 'aaaa'},
];